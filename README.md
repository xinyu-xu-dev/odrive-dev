...
## ODrive Documentation (Chinese) 官方文档（中文）

### For User 面向用户

- [1 Getting Started 快速入门](/docs/001_getting-started_cn.md)
- [2 ODrive Tool 实用工具](/docs/002_odrive-tool_cn.md)
- [3 Parameters and Commands 基础参数与指令](/docs/003_parameters-and-commands_cn.md)
